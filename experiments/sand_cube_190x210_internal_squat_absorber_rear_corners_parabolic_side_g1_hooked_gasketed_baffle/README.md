# Hooked, gasketed parabolic G1 front baffle

This isolated experiment inherits the complete solid-rear printable-bucket
system and replaces only its experimental bucket/baffle joint.  The committed
printable-bucket parent and every earlier enclosure remain unchanged.
...
and hook toe are both below 45 degrees from their print axes, and the two small
angled fastener bores should be fit-coupon tested and may be finish-drilled.

Generated CAD is isolated under:

`build/sand_cube_190x210_internal_squat_absorber_rear_corners_parabolic_side_g1_hooked_gasketed_baffle/`
