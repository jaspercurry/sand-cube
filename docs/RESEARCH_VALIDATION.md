...
- Test one printed M16 x 2.0 thread coupon before committing to a printed fill
...
- Use coarse printed fill-port threads. The current CAD uses M16 x 2.0 because
